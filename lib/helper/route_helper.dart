...
import 'package:sixam_mart_store/features/reports/earinig/screens/earning_report_screen.dart';
...
import 'package:sixam_mart_store/features/service_module/service_report/screens/service_reports_screen.dart';
...
import 'package:sixam_mart_store/features/service_module/service_report/expense/screens/service_expense_screen.dart';
import 'package:sixam_mart_store/features/service_module/service_report/tax/screens/service_tax_report_screen.dart';
import 'package:sixam_mart_store/features/service_module/service_report/disbursement/screens/service_disbursement_screen.dart';
import 'package:sixam_mart_store/features/service_module/service_report/booking/screens/service_booking_report_screen.dart';
...
import 'package:sixam_mart_store/features/service_module/service_reviews/screens/service_customer_review_screen.dart';
import 'package:sixam_mart_store/features/service_module/service_reviews/screens/service_review_reply_screen.dart';
import 'package:sixam_mart_store/features/service_module/custom_service/screens/custom_service_request_list_screen.dart';
...
import 'package:sixam_mart_store/features/service_module/service_campaign/screens/service_campaign_details_screen.dart';
import 'package:sixam_mart_store/features/service_module/service_campaign/screens/service_campaign_screen.dart';
...
import 'package:sixam_mart_store/features/service_module/serviceman/screens/add_service_man_screen.dart';
import 'package:sixam_mart_store/features/service_module/serviceman/screens/service_man_details_screen.dart';
import 'package:sixam_mart_store/features/service_module/serviceman/screens/service_man_screen.dart';
...
import 'package:sixam_mart_store/features/order_edit/screens/edit_order_screen.dart';
import 'package:sixam_mart_store/features/order_edit/screens/add_new_items_screen.dart';
...
import 'package:sixam_mart_store/features/service_module/store/screens/add_service_screen.dart';
import 'package:sixam_mart_store/features/service_module/store/screens/service_details_screen.dart';
...
import 'package:sixam_mart_store/features/service_module/store/screens/pending_service_details_screen.dart';
import 'package:sixam_mart_store/features/service_module/booking_edit/screens/add_booking_service_screen.dart';
import 'package:sixam_mart_store/features/service_module/booking_edit/screens/edit_booking_screen.dart';
import 'package:sixam_mart_store/features/service_module/order/screens/booking_details_screen.dart';
import 'package:sixam_mart_store/features/service_module/store/screens/all_service_screen.dart';
import 'package:sixam_mart_store/features/service_module/store/screens/pending_service_screen.dart';
...
import 'package:sixam_mart_store/features/service_module/provider_config/screens/provider_config_screen.dart';
...
import 'package:sixam_mart_store/features/reels/screens/add_reel_screen.dart';
import 'package:sixam_mart_store/features/reels/screens/reel_details_screen.dart';
import 'package:sixam_mart_store/features/reels/screens/reels_screen.dart';
...
class RouteHelper {
  ...
  static const String serviceCampaign = '/service-campaign';
  static const String serviceCampaignDetails = '/service-campaign-details';
  ...
  static const String providerConfig = '/provider-config';
  ...
  static const String addServiceMan = '/add-service-man';
  static const String serviceManDetails = '/service-man-details';
  ...
  static const String customServiceRequestList = '/custom-service-request-list';
  static const String customServiceRequestDetails = '/custom-service-request-details';
  ...
  static const String pendingServiceDetails = '/pending-service-details';
  static const String bookingDetails = '/booking-details';
  static const String editBooking = '/edit-booking';
  static const String addBookingService = '/add-booking-service';
  ...
  static const String serviceCustomerReview = '/service-customer-review';
  static const String serviceReviewReply = '/service-review-reply';
  ...
  static const String serviceEarningReport = '/service-earning-report';
  static const String serviceExpenseReport = '/service-expense-report';
  static const String serviceTaxReport = '/service-tax-report';
  static const String serviceDisbursementReport = '/service-disbursement-report';
  static const String serviceBookingReport = '/service-booking-report';
  ...
  static String getEditOrderRoute(int orderId) => '$editOrder?id=$orderId';
  static String getAddNewItemsRoute() => addNewItems;
  ...
  static String getServiceCampaignRoute() => serviceCampaign;
  static String getServiceCampaignDetailsRoute({int? id, bool fromNotification = false}) => '$serviceCampaignDetails?id=$id&from_notification=$fromNotification';
  ...
  static String getAddServiceRoute(ServiceModel? serviceModel) {
    if(serviceModel == null) {
      return '$addService?data=null';
    }
    String data = base64Encode(utf8.encode(jsonEncode(serviceModel.toJson())));
    return '$addService?data=$data';
  }
  static String getUpdateServiceRoute(int serviceId) {
    return '$addService?id=$serviceId';
  }
  static String getServiceDetailsRoute(int serviceId) {
    return '$serviceDetails?id=$serviceId';
  }
  ...
  static String getProviderConfigRoute(Store store) {
    List<int> encoded = utf8.encode(jsonEncode(store.toJson()));
    String data = base64Encode(encoded);
    return '$providerConfig?data=$data';
  }
  ...
  static String getServiceManRoute() => serviceMan;
  static String getAddServiceManRoute(ServiceManModel? serviceMan) {
    if(serviceMan == null) {
      return '$addServiceMan?data=null';
    }
    List<int> encoded = utf8.encode(jsonEncode(serviceMan.toJson()));
    String data = base64Encode(encoded);
    return '$addServiceMan?data=$data';
  }
  static String getServiceManDetailsRoute(ServiceManModel serviceMan) {
    List<int> encoded = utf8.encode(jsonEncode(serviceMan.toJson()));
    String data = base64Encode(encoded);
    return '$serviceManDetails?data=$data';
  }
  ...
  static String getCustomServiceRequestListRoute() => customServiceRequestList;
  static String getCustomServiceRequestDetailsRoute(int id) => '$customServiceRequestDetails?id=$id';
  ...
  static String getPendingServiceRoute({bool? fromNotification}) => '$pendingService?from_notification=${fromNotification.toString()}';
  static String getPendingServiceDetailsRoute(int id) => '$pendingServiceDetails?id=$id';
  static String getBookingDetailsRoute(int id, {bool? fromNotification}) => '$bookingDetails?id=$id&from=${fromNotification.toString()}';
  static String getEditBookingRoute(int bookingId) => '$editBooking?id=$bookingId';
  static String getAddBookingServiceRoute() => addBookingService;
  ...
  static String getServiceCustomerReviewRoute() => serviceCustomerReview;
  static String getServiceReviewReplyRoute({bool isGiveReply = false, required ServiceReviewModel review, bool storeReviewReplyStatus = false}){
    List<int> encoded = utf8.encode(jsonEncode(review.toJson()));
    String data = base64Encode(encoded);
    return '$serviceReviewReply?is_give_reply=$isGiveReply&data=$data&store_review_reply_status=$storeReviewReplyStatus';
  }
  ...
  static String getServiceReportsRoute() => serviceReports;
  static String getServiceEarningReportRoute() => serviceEarningReport;
  static String getServiceExpenseReportRoute() => serviceExpenseReport;
  static String getServiceTaxReportRoute() => serviceTaxReport;
  static String getServiceDisbursementReportRoute() => serviceDisbursementReport;
  static String getServiceBookingReportRoute() => serviceBookingReport;
  ...
  static String getReelsRoute() => reels;
  static String getAddReelRoute({Reel? reel}) {
    if (reel != null) {
      List<int> encoded = utf8.encode(jsonEncode(reel.toJson()));
      String data = base64Encode(encoded);
      return '$addReel?data=$data';
    }
    return addReel;
  }
  static String getReelDetailsRoute(Reel reel) {
    List<int> encoded = utf8.encode(jsonEncode(reel.toJson()));
    String data = base64Encode(encoded);
    return '$reelDetails?data=$data';
  }
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: editOrder, page: () => EditOrderScreen(orderId: int.parse(Get.parameters['id']!))),
    GetPage(name: addNewItems, page: () => const AddNewItemsScreen()),
    ...
    GetPage(name: serviceCampaign, page: () => const ServiceCampaignScreen()),
    GetPage(name: serviceCampaignDetails, page: () => ServiceCampaignDetailsScreen(id: int.parse(Get.parameters['id']!), fromNotification: Get.parameters['from_notification'] == 'true')),
    ...
    GetPage(name: addService, page: () {
      if(Get.parameters['id'] != null) {
        return AddServiceScreen(serviceId: int.parse(Get.parameters['id']!));
      }
      if(Get.parameters['data'] == 'null' || Get.parameters['data'] == null) {
        return const AddServiceScreen(service: null);
      }
      List<int> decode = base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
      ServiceModel data = ServiceModel.fromJson(jsonDecode(utf8.decode(decode)));
      return AddServiceScreen(service: data);
    }),
    GetPage(name: serviceDetails, page: () {
      return ServiceDetailsScreen(serviceId: int.parse(Get.parameters['id']!));
    }),
    ...
    GetPage(name: providerConfig, page: () {
      List<int> decode = base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
      Store data = Store.fromJson(jsonDecode(utf8.decode(decode)));
      return ProviderConfigScreen(store: data);
    }),
    ...
    GetPage(name: serviceMan, page: () => const ServiceManScreen()),
    GetPage(name: addServiceMan, page: () {
      if(Get.parameters['data'] == 'null') {
        return const AddServiceManScreen(serviceMan: null);
      }
      List<int> decode = base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
      ServiceManModel data = ServiceManModel.fromJson(jsonDecode(utf8.decode(decode)));
      return AddServiceManScreen(serviceMan: data);
    }),
    GetPage(name: serviceManDetails, page: () {
      List<int> decode = base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
      ServiceManModel data = ServiceManModel.fromJson(jsonDecode(utf8.decode(decode)));
      return ServiceManDetailsScreen(serviceMan: data);
    }),
    ...
    GetPage(name: customServiceRequestList, page: () => const CustomServiceRequestListScreen()),
    GetPage(name: customServiceRequestDetails, page: () => CustomServiceRequestDetailsScreen(requestId: int.parse(Get.parameters['id']!))),
    ...
    GetPage(name: pendingService, page: () => PendingServiceScreen(fromNotification: Get.parameters['from_notification'] == 'true')),
    GetPage(name: pendingServiceDetails, page: () => PendingServiceDetailsScreen(id: int.parse(Get.parameters['id']!))),
    GetPage(name: bookingDetails, page: () => BookingDetailsScreen(bookingId: int.parse(Get.parameters['id']!), fromNotification: Get.parameters['from'] == 'true')),
    GetPage(name: editBooking, page: () => EditBookingScreen(bookingId: int.parse(Get.parameters['id']!))),
    GetPage(name: addBookingService, page: () => const AddBookingServiceScreen()),
    ...
    GetPage(name: serviceCustomerReview, page: () => const ServiceCustomerReviewScreen()),
    GetPage(name: serviceReviewReply, page: () {
      List<int> decode = base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
      ServiceReviewModel data = ServiceReviewModel.fromJson(jsonDecode(utf8.decode(decode)));
      return ServiceReviewReplyScreen(isGiveReply: Get.parameters['is_give_reply'] == 'true', review: data, storeReviewReplyStatus: Get.parameters['store_review_reply_status'] == 'true');
    }),
    ...
    GetPage(name: serviceReports, page: () => const ServiceReportsScreen()),
    GetPage(name: serviceEarningReport, page: () => const ServiceEarningReportScreen()),
    GetPage(name: serviceExpenseReport, page: () => const ServiceExpenseScreen()),
    GetPage(name: serviceTaxReport, page: () => const ServiceTaxReportScreen()),
    GetPage(name: serviceDisbursementReport, page: () => const ServiceDisbursementScreen()),
    GetPage(name: serviceBookingReport, page: () => const ServiceBookingReportScreen()),
    ...
    GetPage(name: allServices, page: () => const AllServiceScreen()),
    ...
    GetPage(name: addReel, page: () {
      Reel? reel;
      if (Get.parameters['data'] != null) {
        List<int> decode = base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
        reel = Reel.fromJson(jsonDecode(utf8.decode(decode)));
      }
      return AddReelScreen(reel: reel);
    }),
    GetPage(name: reelDetails, page: () {
      List<int> decode = base64Decode(Get.parameters['data']!.replaceAll(' ', '+'));
      Reel data = Reel.fromJson(jsonDecode(utf8.decode(decode)));
      return ReelDetailsScreen(reel: data);
    }),
  ];
}