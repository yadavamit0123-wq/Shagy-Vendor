...
class NotificationHelper {
        ...
        if(load.payload!.isNotEmpty){
          ...
          final Map<NotificationType, Function> notificationActions = {
            NotificationType.order: () {
              ...
              }else if(Get.find<AuthController>().getModuleType() == AppConstants.service){
                Get.toNamed(RouteHelper.getBookingDetailsRoute(payload.orderId!, fromNotification: true));
              }else{
                Get.toNamed(RouteHelper.getOrderDetailsRoute(payload.orderId, fromNotification: true));
              }
            },
            NotificationType.service_booking: () => Get.toNamed(RouteHelper.getBookingDetailsRoute(payload.orderId!, fromNotification: true)),
            NotificationType.custom_service_request: () => Get.toNamed(RouteHelper.getCustomServiceRequestDetailsRoute(payload.orderId!)),
            NotificationType.custom_service_bid_selected: () => Get.toNamed(RouteHelper.getCustomServiceRequestDetailsRoute(payload.orderId!)),
            NotificationType.custom_service_bid_denied: () => Get.toNamed(RouteHelper.getCustomServiceRequestDetailsRoute(payload.orderId!)),
      ...
      if(message.data['type'] == 'message' && (Get.currentRoute.startsWith(RouteHelper.chatScreen) || Get.currentRoute.startsWith('/TaxiChatScreen'))) {
        ...
        if (message.data['type'] == 'new_order' || message.data['title'] == 'New order placed') {
          if(Get.find<AuthController>().getModuleType() == 'rental'){
            ...
            Get.find<BookingController>().getRunningBookings();
          }else{
        ...
        final Map<NotificationType, Function> notificationActions = {
          NotificationType.order: () {
            if(Get.find<AuthController>().getModuleType() == 'rental'){
              ...
              Get.toNamed(RouteHelper.getBookingDetailsRoute(int.parse(message.data['order_id']), fromNotification: true));
            }else{
              Get.toNamed(RouteHelper.getOrderDetailsRoute(int.parse(message.data['order_id']), fromNotification: true));
            }
          },
          NotificationType.service_booking: () => Get.toNamed(RouteHelper.getBookingDetailsRoute(notificationBody.orderId!, fromNotification: true)),
          NotificationType.custom_service_request: () => Get.toNamed(RouteHelper.getCustomServiceRequestDetailsRoute(notificationBody.orderId!)),
          NotificationType.custom_service_bid_selected: () => Get.toNamed(RouteHelper.getCustomServiceRequestDetailsRoute(notificationBody.orderId!)),
          NotificationType.custom_service_bid_denied: () => Get.toNamed(RouteHelper.getCustomServiceRequestDetailsRoute(notificationBody.orderId!)),
  ...
  static NotificationBodyModel convertNotification(Map<String, dynamic> data) {
    ...
    switch (type) {
      ...
      case 'service_booking':
        return _handleServiceBookingNotification(data);
      case 'custom_service_request':
        return _handleCustomServiceNotification(data, NotificationType.custom_service_request);
      case 'custom_service_bid_selected':
        return _handleCustomServiceNotification(data, NotificationType.custom_service_bid_selected);
      case 'custom_service_bid_denied':
        return _handleCustomServiceNotification(data, NotificationType.custom_service_bid_denied);
      default:
  ...
  static NotificationBodyModel _handleServiceBookingNotification(Map<String, dynamic> data) {
    final orderId = data['order_id'];
    return NotificationBodyModel(
      orderId: int.tryParse(orderId) ?? 0,
  ...
  static NotificationBodyModel _handleCustomServiceNotification(Map<String, dynamic> data, NotificationType type) {
    final orderId = data['order_id'];
    return NotificationBodyModel(
