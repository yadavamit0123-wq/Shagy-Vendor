...
class ServiceReviewCardWidget extends StatelessWidget {
  final ServiceReviewModel review;
  const ServiceReviewCardWidget({super.key, required this.review});
      ...
      child: Column(children: [
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(review.serviceName ?? '', style: robotoBold, overflow: TextOverflow.ellipsis, maxLines: 2),
        ...
        Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            // Reply Button
            Get.find<SplashController>().configModel!.serviceModule!.providerCanReplyReview ?? false ? CustomButtonWidget(
              onPressed: () => Get.toNamed(RouteHelper.getServiceReviewReplyRoute(isGiveReply: review.reply != null ? false : true, review: review, storeReviewReplyStatus: Get.find<SplashController>().configModel!.storeReviewReply!)),
              width: 95, height: 40,
              radius: 8,
