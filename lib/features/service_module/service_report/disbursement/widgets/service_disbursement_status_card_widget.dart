...
class ServiceDisbursementStatusCardWidget extends StatelessWidget {
  final double amount;
  final String text;
  ...
  const ServiceDisbursementStatusCardWidget({super.key, required this.amount, this.isPending = false, this.isCompleted = false, this.isCanceled = false, required this.text, this.pendingToolTip, this.completeToolTip, this.canceledToolTip});
