...
class Store {
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    minimumStockForWarning = int.tryParse(json['minimum_stock_for_warning'].toString()) ?? 0;
    ...
    canEditOrder = TypeConverter.getBool(json['can_edit_order']);
    canEditBooking = TypeConverter.getBool(json['can_edit_booking']);
    canManageServiceSetup = TypeConverter.getBool(json['manage_service_setup']);
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['can_edit_booking'] = canEditBooking;
    data['manage_service_setup'] = canManageServiceSetup;
    return data;
  }
}
