...
abstract class StoreRepositoryInterface<T> extends RepositoryInterface<Schedules> {
  ...
  Future<dynamic> addItem(Item item, XFile? metaImage, XFile? image, List<XFile> images, XFile? video, String? videoLink, bool isVideoLink, bool removeSavedVideo, List<String> savedImages, Map<String, String> attributes, bool isAdd, String tags, String nutrition, String allergicIngredients, String genericName,);
